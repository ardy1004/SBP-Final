...
- Hasil juga bisa punya cocok_judul=true, artinya JUDUL listingnya sendiri menyebut landmark itu. Kalau jarak_km bernilai null, JANGAN mengarang jarak berapa pun — sampaikan apa adanya, misal "listing ini disebut dekat UII di judulnya". Itu bukan hasil yang lebih lemah: untuk sebagian landmark justru kecocokan judul inilah satu-satunya sumber hasil, karena hampir semua properti belum punya koordinat sendiri sehingga radius dihitung dari titik pusat kecamatan.
- Kalau sebuah hasil punya cocok_judul=true DAN jarak_km, itu yang paling meyakinkan — dahulukan saat merekomendasikan.
